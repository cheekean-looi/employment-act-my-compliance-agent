#!/usr/bin/env python3
# python src/training/train_dpo_fixed.py --train-data outputs/dpo_pairs_train.jsonl --eval-data outputs/dpo_pairs_eval.jsonl --output-dir outputs/lora_dpo --sft-model outputs/lora_sft --model-name meta-llama/Llama-3.1-8B-Instruct --epochs 1 --batch-size 2 --learning-rate 5e-5 --beta 0.1
"""
