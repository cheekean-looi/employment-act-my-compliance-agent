#!/usr/bin/env python3
# python src/training/make_pref_pairs_fixed.py --chunks data/processed/chunks.jsonl --output outputs/dpo_pairs.jsonl --size 60 --seed 42 --sft-model outputs/lora_sft
"""
