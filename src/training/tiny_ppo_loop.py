#!/usr/bin/env python3
# python src/training/tiny_ppo_loop.py --dpo-model outputs/lora_dpo --output outputs/lora_ppo --use-real-ppo --batch-size 32 --mini-batch-size 4 --base-model HuggingFaceTB/SmolLM-135M-Instruct
"""
